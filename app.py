...
# 🔑 API Key Check (Looks for GEMINI_API_KEY)
try:
...
if "chat_session" not in st.session_state:
    ...
    # List for Streamlit to display history (separate from chat_session history)
...
# ----------------------------------------------------------------------
# 3. FILE UPLOAD AND CONTEXT SETUP (For Resume/Image Analysis)
# ----------------------------------------------------------------------
...
if uploaded_file and not st.session_state.uploaded_file_processed:
    ...
    try:
        ...
        with st.spinner("Analyzing resume..."):
            ...
            # Note: We don't need to save the response for streaming here, just send it
    ...
    with st.chat_message("assistant"):
        with st.spinner("Preparing your interview..."):
            ...
            for chunk in response:
                # FIX 2: Safely check for the 'text' attribute to avoid errors
